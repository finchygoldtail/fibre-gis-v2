...
function qgisAutomationScript(draft: JobPackDraft): string {
  ...
  return [
    ...
    "    page.attemptResize(QgsLayoutSize(420, 297, QgsUnitTypes.LayoutMillimeters))",
    ...
    "",
    "    box(0, 0, 420, 297, '#ffffff')",
    "    box(5, 5, 410, 18, '#001326')",
    "    add_label('ALISTRA GIS', 12, 8, 70, 8, 12, True, '#ffffff')",
    "    add_label('ENGINEERING DELIVERY JOB PACK', 12, 18, 95, 4, 3.8, True, '#7dd3fc')",
    `    add_label('${safeProject}', 318, 8, 92, 5, 4.5, True, '#ffffff')`,
    `    add_label('${safeArea}', 318, 16, 92, 5, 4.0, True, '#ffffff')`,
    "",
    "    map_item = QgsLayoutItemMap(layout)",
    "    layout.addLayoutItem(map_item)",
    "    map_item.attemptMove(QgsLayoutPoint(5, 27, QgsUnitTypes.LayoutMillimeters))",
    "    map_item.attemptResize(QgsLayoutSize(360, 264, QgsUnitTypes.LayoutMillimeters))",
    "    map_item.setExtent(sheet_extent)",
    "    map_item.setFrameEnabled(True)",
    "    map_item.setLayers(render_layers(layer_names))",
    "",
    "    box(370, 27, 45, 264, '#ffffff')",
    "    add_label('SHEET', 374, 32, 34, 5, 5.0, True)",
    "    add_label(sheet_title, 374, 42, 34, 18, 4.0, True)",
    "    add_label('BP REVIEW', 374, 70, 34, 5, 4.0, True)",
    "    add_label('Draft', 374, 78, 34, 5, 3.5, False)",
    "    add_label('LEGEND', 374, 96, 34, 5, 4.3, True)",
    "    add_label('Purple Boundary\\nBlue 96F\\nCyan 48F/36F\\nAmber 24F\\nOrange 12F\\nGreen Drops\\nYellow DP\\nPink Joint\\nGrey Chamber\\nWhite Pole\\nHomes: orange dots', 374, 105, 37, 72, 3.2, False)",
    "",
    "    logo_path = layout_dir / 'alistra-gis-logo.svg'",
    "    if logo_path.exists():",
    "        logo = QgsLayoutItemPicture(layout)",
    "        logo.setPicturePath(str(logo_path))",
    "        logo.attemptMove(QgsLayoutPoint(375, 242, QgsUnitTypes.LayoutMillimeters))",
    "        logo.attemptResize(QgsLayoutSize(34, 32, QgsUnitTypes.LayoutMillimeters))",
    "        layout.addLayoutItem(logo)",
    "    else:",
    "        add_label('ALISTRA\\nGIS', 376, 245, 32, 18, 6, True, '#0284c7')",
    "",
    "    add_label('Homes plotted without UPRN labels. Routes, drops and fibre allocations to be reviewed before issue.', 8, 292, 320, 4, 3.2, False, '#475569')",
    "",
    ...
    "    if not route_layer:",
    "        continue",
    "    route_extent = combined_extent([route_layer_name, 'route_context', 'drops'], extent, 1.18)",
